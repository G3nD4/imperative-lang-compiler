...
public class RoutineCallPrimary extends Primary implements JasminConvertable {
    ...
    public static RoutineCallPrimary parse(ParseTree tree, MyLangParser parser) {
        ...
        return new RoutineCallPrimary(identifier, parameters);
    }
